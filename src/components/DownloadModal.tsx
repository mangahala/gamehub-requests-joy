...
import { CheckCircle, Download, Share2, DollarSign } from 'lucide-react';
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      ...
      if (newProgress >= 100) {
        ...
        // Open download link after animation
        setTimeout(() => {
        ...
        <div className="flex flex-col items-center text-center space-y-6 py-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm font-rajdhani">
              {phase === 'downloading' ? 'Preparing your download...' : 'Download started!'}
            </p>
          </div>
          ...
          {phase === 'downloading' ? (
            <div className="w-full space-y-3">
              ...
              <div className="flex items-center justify-center gap-2 text-muted-foreground">
                ...
                <span className="font-rajdhani">Connecting to server...</span>
              </div>
            </div>
          ) : (
            <div className="space-y-4 w-full">
              <div className="flex items-center justify-center gap-2 text-green-500">
                ...
                <span className="font-orbitron text-lg">Download Complete!</span>
              </div>
